    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "btn-lg btn " + /*answer*/ ctx[6].class);
    			add_location(button, file, 8, 16, 305);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*answers*/ 8 && button_class_value !== (button_class_value = "btn-lg btn " + /*answer*/ ctx[6].class)) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "card-title mb-3");
    			add_location(h2, file, 2, 8, 68);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			attr_dev(p, "class", "card-text");
    			add_location(p, file$1, 7, 12, 309);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			p.innerHTML = /*description*/ ctx[0];
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*description*/ 1) p.innerHTML = /*description*/ ctx[0];		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(p);
    		}
    	};
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 12, 43, 466);
    			add_location(i, file$1, 12, 16, 439);
    			attr_dev(p, "class", "card-text");
    			add_location(p, file$1, 11, 12, 401);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, i);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 5, 8, 230);
    			attr_dev(div0, "class", "card-body");
    			add_location(div0, file$1, 4, 4, 198);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$3, 29, 26, 1801);
    			attr_dev(a1, "href", "https://magikaleenprik.nl");
    			add_location(a1, file$3, 29, 86, 1861);
    			attr_dev(h3, "class", "mb-5");
    			add_location(h3, file$3, 29, 4, 1779);
    			attr_dev(h40, "class", "mt-5");
    			add_location(h40, file$3, 32, 5, 1959);
    			add_location(strong, file$3, 37, 6, 2283);
    			add_location(p0, file$3, 34, 5, 2015);
    			...
    			add_location(a2, file$3, 42, 10, 2467);
    			add_location(li0, file$3, 42, 6, 2463);
    			...
    			add_location(a3, file$3, 43, 10, 2658);
    			add_location(li1, file$3, 43, 6, 2654);
    			add_location(ul, file$3, 41, 5, 2452);
    			add_location(p1, file$3, 46, 5, 2897);
    			attr_dev(a4, "href", "https://github.com/jplattel/magikalprikken.nl/issues/new");
    			add_location(a4, file$3, 48, 89, 3199);
    			add_location(p2, file$3, 48, 5, 3115);
    			attr_dev(h41, "class", "mt-5");
    			add_location(h41, file$3, 50, 5, 3302);
    			attr_dev(a5, "href", "https://nl.linkedin.com/in/arjan-sammani");
    			add_location(a5, file$3, 53, 11, 3378);
    			attr_dev(a6, "href", "https://www.linkedin.com/in/chantalvankempen/");
    			add_location(a6, file$3, 53, 73, 3440);
    			attr_dev(a7, "href", "https://www.linkedin.com/in/channah-ruiter/");
    			add_location(a7, file$3, 53, 142, 3509);
    			attr_dev(a8, "href", "https://jplattel.nl");
    			add_location(a8, file$3, 53, 210, 3577);
    			add_location(p3, file$3, 52, 5, 3363);
    			add_location(i0, file$3, 60, 6, 3922);
    			add_location(p4, file$3, 59, 5, 3912);
    			attr_dev(a9, "href", "http://vaccinatie-team.nl/");
    			add_location(a9, file$3, 69, 48, 4350);
    			add_location(i1, file$3, 68, 6, 4298);
    			add_location(p5, file$3, 67, 5, 4288);
    			add_location(i2, file$3, 77, 6, 4824);
    			add_location(p6, file$3, 76, 5, 4814);
    			add_location(blockquote, file$3, 58, 5, 3894);
    			attr_dev(a10, "href", "https://magikalprikken.nl");
    			add_location(a10, file$3, 86, 31, 5290);
    			add_location(p7, file$3, 84, 5, 5147);
    			attr_dev(h42, "class", "mt-5");
    			add_location(h42, file$3, 89, 5, 5380);
    			attr_dev(a11, "href", "https://twitter.com/jplattel");
    			add_location(a11, file$3, 92, 189, 5612);
    			add_location(p8, file$3, 91, 5, 5419);
    			attr_dev(h43, "class", "mt-5");
    			add_location(h43, file$3, 95, 5, 5713);
    			attr_dev(a12, "href", "https://github.com/jplattel/magikalprikken.nl");
    			add_location(a12, file$3, 99, 34, 5921);
    			add_location(code, file$3, 100, 89, 6137);
    			add_location(p9, file$3, 97, 5, 5768);
    			attr_dev(div0, "class", "text-start");
    			add_location(div0, file$3, 31, 4, 1929);
    			attr_dev(a13, "href", "#");
    			attr_dev(a13, "class", "btn btn-outline-light");
    			add_location(a13, file$3, 105, 5, 6219);
    			attr_dev(div1, "class", "d-grid mb-3");
    			add_location(div1, file$3, 104, 4, 6188);
    			attr_dev(div2, "class", "col-md-8");
    			add_location(div2, file$3, 27, 3, 1751);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, h3);
    			...
    			append_dev(p4, i0);
    			append_dev(blockquote, t33);
    			append_dev(blockquote, p5);
    			append_dev(p5, i1);
    			append_dev(i1, t34);
    			append_dev(i1, a9);
    			append_dev(i1, t36);
    			append_dev(blockquote, t37);
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = space();
    			p1 = element("p");
    			t13 = text("Nieuwsgierig wie dit heeft gemaakt en waarom? Lees er ");
    			a2 = element("a");
    			a2.textContent = "hier";
    			...
    			add_location(a0, file$3, 9, 42, 302);
    			...
    			add_location(a1, file$3, 9, 238, 498);
    			add_location(strong, file$3, 10, 66, 758);
    			attr_dev(p0, "class", "text-start");
    			add_location(p0, file$3, 8, 4, 237);
    			attr_dev(button, "class", "btn btn-outline-dark mt-3");
    			attr_dev(button, "id", "reset");
    			add_location(button, file$3, 15, 4, 912);
    			add_location(hr, file$3, 17, 4, 1004);
    			attr_dev(a2, "href", "#");
    			add_location(a2, file$3, 20, 59, 1096);
    			attr_dev(a3, "href", "https://github.com/jplattel/magikalprikken.nl/issues");
    			add_location(a3, file$3, 21, 28, 1177);
    			...
    			add_location(a4, file$3, 22, 46, 1320);
    			attr_dev(a5, "href", "https://www.facebook.com/sharer/sharer.php?u=https://magikaleenprik.nl/");
    			attr_dev(a5, "target", "_blank");
    			attr_dev(a5, "rel", "_noopener");
    			add_location(a5, file$3, 23, 8, 1568);
    			attr_dev(p1, "class", "text-start");
    			add_location(p1, file$3, 19, 4, 1014);
    			attr_dev(div, "class", "col-md-6");
    			add_location(div, file$3, 7, 3, 209);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (switch_value !== (switch_value = steps[/*state*/ ctx[0]].type)) {
    				...
    				if (switch_value) {
    					...
    					mount_component(switch_instance, div, t9);
    				} else {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			h1 = element("h1");
    			t0 = text("Mag ik al een prik?");
    			span = element("span");
    			span.textContent = "💉";
    			t2 = space();
    			if (if_block) if_block.c();
    			attr_dev(span, "class", "no-underline");
    			add_location(span, file$3, 3, 22, 134);
    			attr_dev(h1, "class", "my-5 display-3");
