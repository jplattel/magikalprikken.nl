    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*description*/ ctx[0]);
    			attr_dev(p, "class", "card-text");
    			add_location(p, file$1, 4, 12, 212);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 9, 43, 363);
    			add_location(i, file$1, 9, 16, 336);
    			attr_dev(p, "class", "card-text");
    			add_location(p, file$1, 8, 12, 298);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, i);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "card-title mb-3");
    			add_location(h3, file$1, 2, 8, 133);
    			attr_dev(div0, "class", "card-body");
    			add_location(div0, file$1, 1, 4, 101);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t18 = text("Wij (");
    			a3 = element("a");
    			a3.textContent = "Arjan";
    			t20 = text(", ");
    			a4 = element("a");
    			a4.textContent = "Chantal";
    			t22 = text(", ");
    			a5 = element("a");
    			a5.textContent = "Channah";
    			t24 = text(" & ");
    			a6 = element("a");
    			a6.textContent = "Joost";
    			t26 = text(") hebben in een avond dit systeem bedacht en gemaakt.\n\t\t\t\t\t\tDit systeem heeft een simpel doel: mensen informeren wanneer en hoe ze worden geprikt. We\n\t\t\t\t\t\tsnappen ook niet waarom het zo moeilijk was, maar nemen je graag mee in het verhaal. Het\n\t\t\t\t\t\tbegon allemaal zo.");
    			t27 = space();
    			p4 = element("p");
    			p4.textContent = "De ouders van Chantal zouden mogelijk in aanmerking komen voor een COVID-19 vaccin, maar\n\t\t\t\t\t\twas dat ook echt zo? Chantal, opgeleid psychologe en nu consultant (waarom dit ertoe doet\n\t\t\t\t\t\tvertellen we je zo) keek op de website van de overheid maar kwam er niet uit. Krijgen haar\n\t\t\t\t\t\touders nou een prik? Wanneer dan? En hoe?";
    			t29 = space();
    			p5 = element("p");
    			t30 = text("Ze vroegen het Arjan (Arts, oprichter van ");
    			a7 = element("a");
    			a7.textContent = "Stichting Vaccinatie-Team";
    			t32 = text(", ervaring op Corona afdeling, \n\t\t\t\t\t\tdie zal het vast weten). Die wist het ook niet, dus\n\t\t\t\t\t\thij keek op de website van de Rijksoverheid (die organisatie die ons ook een tip gaf over hoe\n\t\t\t\t\t\tvoetbal te kijken en sneeuwballen te gooien tijdens corona). Samen met Channah (praktiserend\n\t\t\t\t\t\tpsycholoog) en Joost (ondernemer & data strateeg) kwamen we er ook niet uit.");
    			t33 = space();
    			p6 = element("p");
    			p6.textContent = "Dus waarom is het belangrijk dat Chantal consultant is, Arjan arts, Channah psycholoog en\n\t\t\t\t\t\tJoost data-strateeg? Omdat deze club semi-intellectuelen het systeem blijkbaar ook niet\n\t\t\t\t\t\tsnappen. Dan zijn wij niet slim genoeg of is de uitleg te complex (of beiden 🤓).";
    			t35 = space();
    			p7 = element("p");
    			t36 = text("We denken niet dat het ligt aan de Rijksoverheid, maar aan de complexe onderneming die het vaccineren\n\t\t\t\t\t\tgeworden is. Dus vandaar ");
    			a8 = element("a");
    			a8.textContent = "magikalprikken.nl";
    			t38 = text(" als oplossing!");
    			t39 = space();
    			h42 = element("h4");
    			h42.textContent = "En verder?";
    			t41 = space();
    			p8 = element("p");
    			t42 = text("Ben je van de Rijksoverheid en vind je het interessant om dit verder op te pakken zodat het wat makkelijk wordt? Of ben je van de pers en nieuwsgierig naar het hele verhaal? Volg dan ");
    			a9 = element("a");
    			a9.textContent = "Joost op twitter";
    			t44 = text(" en stuur een DM/mention.");
    			t45 = space();
    			h43 = element("h4");
    			h43.textContent = "Privacy & data verzameling";
    			t47 = space();
    			p9 = element("p");
    			t48 = text("Er wordt op deze website geen enkele data verzameld of verzonden naar derden. Geen cookies & geen tracking. \n\t\t\t\t\t\tDe pagina's staan gehost op ");
    			a10 = element("a");
    			a10.textContent = "Github";
    			t50 = text(", als mede ook alle code, dus die kan je zelf ook bekijken. \n\t\t\t\t\t\tDaarnaast maken we gebruik van Cloudflare for caching en de beveiligde verbinding (");
    			code = element("code");
    			...
    			div1 = element("div");
    			a11 = element("a");
    			a11.textContent = "« terug naar de vragen";
    			...
    			add_location(a3, file$3, 53, 11, 3132);
    			attr_dev(a4, "href", "https://www.linkedin.com/in/chantalvankempen/");
    			add_location(a4, file$3, 53, 73, 3194);
    			attr_dev(a5, "href", "https://www.linkedin.com/in/channah-ruiter/");
    			add_location(a5, file$3, 53, 142, 3263);
    			attr_dev(a6, "href", "https://jplattel.nl");
    			add_location(a6, file$3, 53, 210, 3331);
    			add_location(p3, file$3, 52, 5, 3117);
    			add_location(p4, file$3, 58, 5, 3655);
    			attr_dev(a7, "href", "http://vaccinatie-team.nl/");
    			add_location(a7, file$3, 65, 48, 4062);
    			add_location(p5, file$3, 64, 5, 4010);
    			add_location(p6, file$3, 71, 5, 4515);
    			attr_dev(a8, "href", "magikalprikken.nl");
    			add_location(a8, file$3, 78, 31, 4956);
    			add_location(p7, file$3, 76, 5, 4813);
    			add_location(h42, file$3, 81, 5, 5038);
    			attr_dev(a9, "href", "https://twitter.com/jplattel");
    			add_location(a9, file$3, 84, 189, 5257);
    			add_location(p8, file$3, 83, 5, 5064);
    			add_location(h43, file$3, 87, 5, 5358);
    			attr_dev(a10, "href", "https://github.com/jplattel/magikalprikken.nl");
    			add_location(a10, file$3, 91, 34, 5553);
    			add_location(code, file$3, 92, 89, 5769);
    			add_location(p9, file$3, 89, 5, 5400);
    			attr_dev(div0, "class", "text-start");
    			add_location(div0, file$3, 32, 4, 1731);
    			attr_dev(a11, "href", "#");
    			attr_dev(a11, "class", "btn btn-outline-primary");
    			add_location(a11, file$3, 96, 5, 5845);
    			attr_dev(div1, "class", "d-grid mb-3");
    			add_location(div1, file$3, 95, 4, 5814);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(a11, "click", /*readMore*/ ctx[4], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
